...
from controller import InteractiveWidgets
...
class GameUI:
    ...
    @property
    def coord_text(self):
        """Make _coord_input_text a property, not a private attribute."""
        return self._coord_input_text

    @property
    def score_text(self):
        """Make _score_text a property, not a private attribute."""
        return self._score_text

    @property
    def average_score_text(self):
        """Make _average_score_text a property, not a private attribute."""
        return self._average_score_text

    @property
    def distance_text(self):
        """Make _distance_text a property, not a private attribute."""
